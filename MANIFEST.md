...
### src/core/ (Core Engine — 21 objects)
...
| ZCL_ARK_TEXTS | CLAS | Framework UI texts by logon language (zh/en, en fallback; unit-tested completeness) |
| ZCL_ARK_ACTIONS | CLAS | Reserved action-name registry (ark_* namespace: back/sort/filter/download) |
