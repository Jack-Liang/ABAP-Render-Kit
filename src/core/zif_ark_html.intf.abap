INTERFACE zif_ark_html PUBLIC.
  TYPES:
    BEGIN OF ty_data_attr, name TYPE string, value TYPE string,
    END OF ty_data_attr,
    ty_data_attrs TYPE STANDARD TABLE OF ty_data_attr WITH KEY name.
  CONSTANTS:
    BEGIN OF c_action_type, sapevent TYPE c VALUE 'E', url TYPE c VALUE 'U',
      onclick TYPE c VALUE 'C', separator TYPE c VALUE 'S', dummy TYPE c VALUE '_',
    END OF c_action_type .
  CONSTANTS:
    BEGIN OF c_html_opt, strong TYPE c VALUE 'E', cancel TYPE c VALUE 'C',
  ...
  METHODS add_a IMPORTING !iv_txt TYPE string !iv_act TYPE string !iv_query TYPE string OPTIONAL
                          !iv_typ TYPE c DEFAULT c_action_type-sapevent !iv_opt TYPE clike OPTIONAL
  ...
  METHODS wrap IMPORTING !iv_tag TYPE string !iv_content TYPE string OPTIONAL
                       ...
                       !iv_style TYPE string OPTIONAL !iv_format_single_line TYPE abap_bool DEFAULT abap_false
                       !is_data_attr TYPE ty_data_attr OPTIONAL !it_data_attrs TYPE ty_data_attrs OPTIONAL
               RETURNING VALUE(ri_self) TYPE REF TO zif_ark_html.
  METHODS td IMPORTING !iv_content TYPE string OPTIONAL !ii_content TYPE REF TO zif_ark_html OPTIONAL
                     !iv_id TYPE string OPTIONAL !iv_class TYPE string OPTIONAL
                     !iv_hint TYPE string OPTIONAL !iv_style TYPE string OPTIONAL
                     !iv_format_single_line TYPE abap_bool DEFAULT abap_true
                     !is_data_attr TYPE ty_data_attr OPTIONAL !it_data_attrs TYPE ty_data_attrs OPTIONAL
             PREFERRED PARAMETER iv_content RETURNING VALUE(ri_self) TYPE REF TO zif_ark_html.
  METHODS th IMPORTING !iv_content TYPE string OPTIONAL !ii_content TYPE REF TO zif_ark_html OPTIONAL
                     !iv_id TYPE string OPTIONAL !iv_class TYPE string OPTIONAL
                     !iv_hint TYPE string OPTIONAL !iv_style TYPE string OPTIONAL
                     !iv_format_single_line TYPE abap_bool DEFAULT abap_true
                     !is_data_attr TYPE ty_data_attr OPTIONAL !it_data_attrs TYPE ty_data_attrs OPTIONAL
             PREFERRED PARAMETER iv_content RETURNING VALUE(ri_self) TYPE REF TO zif_ark_html.
  METHODS div IMPORTING !iv_content TYPE string OPTIONAL !ii_content TYPE REF TO zif_ark_html OPTIONAL
                      !iv_id TYPE string OPTIONAL !iv_class TYPE string OPTIONAL
                      !iv_style TYPE string OPTIONAL !is_data_attr TYPE ty_data_attr OPTIONAL
